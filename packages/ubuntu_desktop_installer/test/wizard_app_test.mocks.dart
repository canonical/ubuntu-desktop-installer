...
// in ubuntu_desktop_installer/test/wizard_app_test.dart.
...
import 'package:subiquity_client/subiquity_server.dart' as _i6;
...
class MockSubiquityServer extends _i1.Mock implements _i6.SubiquityServer {
  ...
  @override
  _i4.Future<String> start(_i6.ServerMode? serverMode,
          [String? machineConfig = r'']) =>
      (super.noSuchMethod(
          Invocation.method(#start, [serverMode, machineConfig]),
          returnValue: Future<String>.value('')) as _i4.Future<String>);
  @override
