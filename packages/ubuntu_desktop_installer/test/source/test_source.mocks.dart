...
import 'package:ubuntu_desktop_installer/pages/source/source_model.dart' as _i8;
...
class MockNetworkService extends _i1.Mock implements _i5.NetworkService {
  ...
  @override
  Map<String, Map<String, _i7.DBusValue>> getWifiSettings(
      ...
      (super.noSuchMethod(
        ...
        returnValue: <String, Map<String, _i7.DBusValue>>{},
      ) as Map<String, Map<String, _i7.DBusValue>>);
  @override
  ...
  _i6.Future<_i3.NetworkManagerActiveConnection> addAndActivateConnection({
    Map<String, Map<String, _i7.DBusValue>>? connection = const {},
...
///
/// See the documentation for Mockito's code generation for more information.
class MockPowerService extends _i1.Mock implements _i5.PowerService {
  MockPowerService() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSourceModel extends _i1.Mock implements _i8.SourceModel {
  MockSourceModel() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i2.SourceSelection> get sources => (super.noSuchMethod(
        Invocation.getter(#sources),
        returnValue: <_i2.SourceSelection>[],
      ) as List<_i2.SourceSelection>);
  @override
  ...
  @override
  _i6.Future<void> setSourceId(String? sourceId) => (super.noSuchMethod(
        Invocation.method(
          #setSourceId,
          [sourceId],
        ),
...
class MockTelemetryService extends _i1.Mock implements _i5.TelemetryService {
  ...
  @override
  _i6.Future<void> init([Map<String, dynamic>? metrics = const {}]) =>
      (super.noSuchMethod(
        Invocation.method(
          #init,
          [metrics],
  ...
  @override
  _i6.Future<void> addStage(String? name) => (super.noSuchMethod(
        Invocation.method(
          #addStage,
          [name],
        ),
  ...
  @override
  _i6.Future<void> addMetrics(Map<String, dynamic>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #addMetrics,
          [entries],
