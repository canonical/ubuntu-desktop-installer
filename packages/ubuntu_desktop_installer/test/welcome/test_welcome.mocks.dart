...
import 'package:ubuntu_wizard/utils.dart' as _i6;
...
class MockNetworkService extends _i1.Mock implements _i3.NetworkService {
  ...
  @override
  Map<String, Map<String, _i5.DBusValue>> getWifiSettings(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockWelcomeModel extends _i1.Mock implements _i7.WelcomeModel {
  MockWelcomeModel() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Option get option => (super.noSuchMethod(
        Invocation.getter(#option),
        returnValue: _i7.Option.none,
      ) as _i7.Option);
  @override
  bool get isConnected => (super.noSuchMethod(
        Invocation.getter(#isConnected),
  ...
  @override
  void selectOption(_i7.Option? option) => super.noSuchMethod(
        Invocation.method(
          #selectOption,
          [option],
        ),
  ...
  String releaseNotesURL(
    _i8.Locale? locale, {
    _i9.FileSystem? fs = const _i10.LocalFileSystem(),
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #releaseNotesURL,
