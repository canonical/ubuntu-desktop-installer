...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'The official documentation covers many of the most common areas about {RELEASE}. It\'s available both <strong>online</strong> and via the Help icon in the dock.'**
  String supportSlideDocumentation(Object RELEASE);

  /// No description provided for @supportSlideQuestions.
  ///
  /// In en, this message translates to:
  /// **'At <strong>Ask Ubuntu</strong> you can ask questions and search an impressive collection of already answered questions. Support in your own language may be provided at your <strong>Local Community Team</strong>.'**
  String get supportSlideQuestions;

  /// No description provided for @supportSlideResources.
  ///
  /// In en, this message translates to:
  /// **'For pointers to other useful resources, please visit <strong>Community support</strong> or <strong>Commercial support</strong>.'**
