...
class InstallationSlidesPageMock extends StatefulWidget {
  const InstallationSlidesPageMock({
    Key? key,
  }) : super(key: key);
  ...
  static Widget create(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      ...
      child: InstallationSlidesPageMock(),
    );
  }

  @override
  InstallationSlidesPageMockState createState() =>
      InstallationSlidesPageMockState();
}

class InstallationSlidesPageMockState
    extends State<InstallationSlidesPageMock> {
  @override
  void initState() {
    super.initState();
