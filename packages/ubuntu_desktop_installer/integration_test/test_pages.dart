...
Future<void> takeScreenshot(WidgetTester tester, String screenshot) async {
  ...
  final fileName = Theme.of(context).brightness == Brightness.dark
      ? 'screenshots/dark/$screenshot.png'
      : 'screenshots/light/$screenshot.png';

  await expectLater(find.byType(WizardPage), matchesGoldenFile(fileName));
}
